...
@JobHandler(value="send_msg_by_ysj_openid_09_0930")
@Component
/*
 * 指定YSJOpenId推送微信模板消息09_0930
 * 
 * 
 */
public class SendMsgByYSJOpenIdJobHandler09_0930 extends IJobHandler {
	protected final static Logger logger = LoggerFactory.getLogger(SendMsgByYSJOpenIdJobHandler09_0930.class);
...
//  	private final String HOST = "http://"+"wx.yunovo.cn";
	...
	public String toTemMesJson1 (String openid, String url) {
		...
		data.put("first", toVC_JsonObj("#5折狂欢#来袭！\n\n9日至11日，全场流量5折，今年最后一次大福利，千万别错过！\n\n","#FF2400"));
		data.put("keyword1", toVC_JsonObj("已开抢","#000001"));
		data.put("keyword2", toVC_JsonObj("2019.11.9-2019.11.11","#000001"));
