...
@JobHandler(value="send_msg_by_ysj_openid_11_1930")
@Component
/*
 ...
 * 
 */
public class SendMsgByYSJOpenIdJobHandler11_1900 extends IJobHandler {
	protected final static Logger logger = LoggerFactory.getLogger(SendMsgByYSJOpenIdJobHandler11_1900.class);
...
//  	private final String HOST = "http://"+"wx.yunovo.cn";
	...
	public String toTemMesJson1 (String openid, String url) {
		...
		data.put("first", toVC_JsonObj("最后5小时！\n\n全场流量5折，今年最后一次大福利，错过等一年！\n","#FF2400"));
