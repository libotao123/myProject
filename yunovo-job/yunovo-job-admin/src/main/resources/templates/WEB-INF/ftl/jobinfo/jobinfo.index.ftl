	...
	<div class="content-wrapper">
	    ...
	    <section class="content">
	    	...
	    	<div class="row" style="margin-bottom:1%">
                ...
                <div class="col-xs-3">
                    <div class="input-group">
                        <span class="input-group-addon">java任务入口</span>
                        <input type="text" class="form-control" id="executorHandler" autocomplete="on" >
                    </div>
                </div>
	            <div class="col-xs-1">
	            	<button class="btn btn-block btn-info" id="searchBtn"><span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;&nbsp;${I18n.system_search}</button>
	            </div>
	            <div class="col-xs-1">
	            	<button class="btn btn-block btn-success add" type="button"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;${I18n.jobinfo_field_add}</button>
	            </div>
          	</div>
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <label for="lastname" class="col-sm-2 control-label">时间格式<font color="red">*</font></label>
                    ...
                    <div class="form-group">
                        ...
                        <label for="firstname" class="col-sm-2 control-label">java任务入口<font color="black">*</font></label>
...
package cn.yunovo.job.service.handler;
...
<textarea class="glueSource_php" id="glueSource_php" style="display:none;" >
<?php
