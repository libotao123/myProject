                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form" >
                        <div class="form-group">
                            <label for="lastname" class="col-sm-3 control-label">执行器代码<font color="red">*</font></label>
                        ...
                        <div class="form-group">
                            <label for="lastname" class="col-sm-3 control-label">${I18n.jobgroup_field_title}<font color="red">*</font></label>
                            <div class="col-sm-9"><input type="text" class="form-control" name="title" placeholder="${I18n.system_please_input}${I18n.jobgroup_field_title}" maxlength="12" ></div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-3 control-label">${I18n.jobgroup_field_order}<font color="red">*</font></label>
                            <div class="col-sm-9"><input type="text" class="form-control" name="order" placeholder="${I18n.system_please_input}${I18n.jobgroup_field_order}" maxlength="50" ></div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-3 control-label">${I18n.jobgroup_field_addressType}<font color="red">*</font></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="lastname" class="col-sm-3 control-label">${I18n.jobgroup_field_registryList}<font color="red">*</font></label>
                            <div class="col-sm-9">
