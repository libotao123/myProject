$(function() {
	...
	$('.remove').on('click', function(){
		...
		layer.confirm( (I18n.system_ok + I18n.jobgroup_del + '？') , {
			...
			$.ajax({
				type : 'POST',
				url : base_url + '/secure/jobgroup/remove',
				data : {"id":id},
				dataType : "json",
	...
	var addModalValidate = $("#addModal .form").validate({
		...
		submitHandler : function(form) {
			$.post(base_url + "/secure/jobgroup/save",  $("#addModal .form").serialize(), function(data, status) {
				if (data.code == "200") {
					$('#addModal').modal('hide');
					layer.open({
						title: I18n.system_tips ,
	...
	var updateModalValidate = $("#updateModal .form").validate({
		...
		submitHandler : function(form) {
			$.post(base_url + "/secure/jobgroup/update",  $("#updateModal .form").serialize(), function(data, status) {
				if (data.code == "200") {
					$('#addModal').modal('hide');
