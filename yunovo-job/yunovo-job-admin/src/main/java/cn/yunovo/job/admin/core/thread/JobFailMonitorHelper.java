package cn.yunovo.job.admin.core.thread;
...
import cn.yunovo.job.admin.core.util.MailUtil;
					...
					try {
						...
						if (CollectionUtils.isNotEmpty(jobLogIdList)) {
							for (Integer jobLogId : jobLogIdList) {
								...
								} else if (IJobHandler.SUCCESS.getCode() == log.getHandleCode() || 202 == log.getHandleCode()) {
									// job success, pass
