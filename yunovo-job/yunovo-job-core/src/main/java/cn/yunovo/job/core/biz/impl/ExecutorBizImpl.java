package cn.yunovo.job.core.biz.impl;

import cn.yunovo.job.core.biz.ExecutorBiz;
import cn.yunovo.job.core.biz.model.LogResult;
...
import cn.yunovo.job.core.executor.XxlJobExecutor;
import cn.yunovo.job.core.glue.GlueFactory;
import cn.yunovo.job.core.glue.GlueTypeEnum;
import cn.yunovo.job.core.handler.IJobHandler;
import cn.yunovo.job.core.handler.impl.GlueJobHandler;
import cn.yunovo.job.core.handler.impl.ScriptJobHandler;
import cn.yunovo.job.core.log.XxlJobFileAppender;
import cn.yunovo.job.core.thread.JobThread;
...
public class ExecutorBizImpl implements ExecutorBiz {
    ...
    public ReturnT<String> run(TriggerParam triggerParam) {
        ...
        System.out.println("glueType[" + triggerParam.getGlueType());
        System.out.println(glueTypeEnum);
        System.out.println(glueTypeEnum.isScript());
